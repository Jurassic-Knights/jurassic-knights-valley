---
name: reasoner-planner
description: Proactive planning and reasoning before taking any action. Use when planning multi-step tasks, debugging, or when the user requests methodical reasoning.
---

# Reasoner-Planner Protocol
