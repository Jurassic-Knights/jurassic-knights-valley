...
const entity: EntityConfig = {
    ...
    status: 'pending',
    files: {
        original: 'assets/images/ground/ground_overgrown_leaves_grasslands_02_original.png',
        clean: 'assets/images/ground/ground_overgrown_leaves_grasslands_02_original.png'
    },
    type: 'ground_texture',
    biome: 'grasslands',
    display: {
