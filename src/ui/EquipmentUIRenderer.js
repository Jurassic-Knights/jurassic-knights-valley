...
class EquipmentUIRenderer {
            ...
            <div class="equip-panel">
                ...
                <div class="equip-summary-bar ${item ? 'has-item' : 'empty'}">
                    ...
                    <div class="item-stats-row">
                        ${itemDamage ? `<div class="summary-stat"><span class="stat-icon">⚔️</span> DMG <span>+${itemDamage}</span></div>` : ''}
                        ${itemArmor ? `<div class="summary-stat"><span class="stat-icon">🛡️</span> ARM <span>+${itemArmor}</span></div>` : ''}
    ...
    static getItemIcon(itemId) {
        if (window.AssetLoader && AssetLoader.getImagePath) {
    ...
    static loadIcons(container) {
        if (window.AssetLoader && AssetLoader.loadIcons) {
