...
class EnvironmentRenderer {
    ...
    setWeather(type) {
        ...
        else if (type === 'STORM' && this.vfx.RAIN) this.vfx.RAIN.active = true; // Storm reuses Rain for now
        ...
        if (this.game) {
            ...
            if (renderer) {
                ...
                if (renderer.viewport) {
                    ...
                    if (this.lastViewport.x === 0 && this.lastViewport.y === 0 && (viewport.x !== 0 || viewport.y !== 0)) {
